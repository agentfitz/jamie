<?php get_header(); ?>
	...
	<div id="wrap_intro" class="wrap" >	
		<div class="container">
			<div class="intro">
				<?php 
					$pageTitle = have_posts() ? sprintf(__("Search Results for '%s'", TEXTDOMAIN), $s) : _e('No Results Found', TEXTDOMAIN);
				?>
	...
	<div id="wrap_main" class="wrap" >
		...
		<div id="main" class="container">
			...
			<div class="row">
				...
				<?php else: ?>
					<div id="post-0" >
						<p><?php _e("Sorry, but you are looking for something that isn't here. Try another search", TEXTDOMAIN); ?></p>
					</div>
				<?php endif; ?>
				</div>
				<!--Sidebar-->
