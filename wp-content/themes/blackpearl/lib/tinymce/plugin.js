	...
	tinymce.create("tinymce.plugins.pxShortcodes",
	{
		...
		createControl: function ( button, e )
		{
			...
			button.onRenderMenu.add(function (c, b)
			{
			    ...
			    plugin.addPopupMenuButton(b, "Lists", "lists");
				...
				plugin.addPopupMenuButton(b, "Message Box", "messagebox");
				plugin.addPopupMenuButton(b, "Alert", "alert");

				b.addSeparator();

				plugin.addPopupMenuButton(b, "Dropcaps", "dropcap");
				plugin.addPopupMenuButton(b, "Pullquotes", "pullquote");
