...
class PortfolioPostMeta extends PostMeta
{
	...
	{
		return array('intro_type', 'intro_title', 'intro_desc',
	...
	function RegisterScripts()
	{
		...
		wp_enqueue_script('portfolio-meta', THEME_ADMIN_URI  .'/scripts/portfolio-meta.js', array('jquery'), '1.0.0');
	}
	...
	{
		$page = include(THEME_LIB . '/theme-portfolio-meta-forms.php');
	}
}
