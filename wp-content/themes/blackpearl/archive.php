		...
		<div class="container">
			<div class="intro">
				<?php 
					...
					elseif( is_day() ){
						$pageTitle = sprintf(__('Archive for %', TEXTDOMAIN), get_the_time('F jS, Y'));
					}
					elseif( is_month() ){
						$pageTitle = sprintf(__('Archive for %', TEXTDOMAIN), get_the_time('F, Y'));
					}
					elseif ( is_year() ){
						$pageTitle = sprintf(__('Archive for %', TEXTDOMAIN), get_the_time('Y') );
					}
					elseif ( is_author() ){
						/* Get author data */
						...
						$pageTitle = sprintf(__('Posts by %', TEXTDOMAIN), $curauth->display_name );
					}
